...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ShiftViewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/daviwiki/ShiftViewController'
  ...
  # s.resource_bundles = {
  #   'ShiftViewController' => ['ShiftViewController/Assets/*.png']
  # }
